...
public class EmployeeController {
	...
	public ResponseEntity<Map<String, String>> findId(@RequestBody Map<String, String> request) {
		...
		String foundId = employeeService.findIdByNameAndEmail(name, email); // 서비스에서 실제 조회
	...
	public ResponseEntity<List<FacilityEmployeeDTO>> listSearch(
		...
		List<FacilityEmployeeDTO> list = employeeService.getListSearch(searchField,
				searchWord, "FULL");
	...
	public ResponseEntity<List<FacilityEmployeeDTO>> listWithPaging(@PathVariable int page,
	...
	public ResponseEntity<List<FacilityEmployeeDTO>> listSearchWithPagingModal(
		...
		return ResponseEntity
				.ok(employeeService.getListSearchWithPaging(searchField, searchWord, page, size, "MODAL"));
	}
